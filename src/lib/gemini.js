...
Say:
"Если зуб удаётся сохранить, лечение обычно стоит от 3 900 до 12 000 ₽. Если понадобится коронка, чаще всего выходит 32 000–42 000 ₽."
...
CLINIC PRICE LIST — use these exact numbers, never invent others:
- Лечение зуба (пломба) — от 3 900 ₽
- Вкладка — от 18 000 ₽
- Коронка — от 32 000 ₽
- Имплантация под ключ (имплант + абатмент + коронка) — от 42 000 ₽
- Виниры E.max — от 18 000 ₽
- Отбеливание Zoom4 — от 18 000 ₽
